...
async function build() {
    const stages = helpers_1.getBaseStages();
    ...
    core.setOutput('commit', helpers_1.getFullCommitHash());
...
function getAllPossibleCacheTargets() {
    const tags = [helpers_1.getTagForRun(), 'latest'];
    const stages = helpers_1.getAllStages();
    const repo = core.getInput('repository');
